...
## Версионирование
На данный момент планируется множество работ, направленных на расширения функционала api. Текущая версия не подходит для какого-либо использования внутри продукта, поэтому и вводить какую-либо версию для этой итерации не вижу смысла
